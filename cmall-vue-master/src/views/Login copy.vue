      ...
      <div class="login">
        <el-card class="box-card">
          ...
          <div class="logo">
            ...
            <div class="logo-login">
              <div @click="qqInit">
                <img src="../assets/imgs/Weixinlogo.png" width="16px" height="16px" alt />
              </div>
            </div>
            <div class="logo-login">
              <div @click="qqInit">
                <img src="../assets/imgs/Zhifubaologo.png" width="16px" height="16px" alt />
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    qqInit() {
      userAPI.qqInit().then(res => res.status === 200 && (window.location.href = res.data))
    },
...
.checkbox-edging {
  display: inline-block; /* 使复选框��框在同一行 */
  vertical-align: middle; /* 垂直居中对齐 */
}
