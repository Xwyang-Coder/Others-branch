      ...
      <el-card class="box-card" shadow="hover">
        ...
        <div class="item">
          ...
          <div style="margin-top:15px">
            <a href="javascript:;" class="btn-gradient-register" @click="register('form')">注册</a>
          </div>
          <el-link type="primary" href="/#/login" style="float:right;margin-bottom:18px;">已有账号？直接登录></el-link>
        </div>
      </el-card>
    </div>
  </div>
